...
CREATE TABLE `shopping_cart` (
  ...
  PRIMARY KEY (`id`),
  KEY `shopping_cart_user_id_users_id_fk` (`user_id`),
  CONSTRAINT `shopping_cart_user_id_users_id_fk` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
-- Dump completed on 2021-02-06 23:26:45
